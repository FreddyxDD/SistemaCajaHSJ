    ...
    <body class="min-h-screen bg-white antialiased dark:bg-linear-to-b dark:from-neutral-950 dark:to-neutral-900">
        <div class="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
            <div class="relative hidden h-full flex-col justify-between overflow-hidden p-10 text-white lg:flex dark:border-e dark:border-neutral-800">
                <div class="absolute inset-0 bg-linear-to-br from-emerald-950 via-neutral-950 to-neutral-950"></div>
                <div class="absolute -top-24 -right-24 h-96 w-96 rounded-full bg-emerald-500/10 blur-3xl"></div>
                <div class="absolute -bottom-32 -left-16 h-96 w-96 rounded-full bg-emerald-400/10 blur-3xl"></div>
                ...
                <div class="relative z-20 space-y-8">
                    ...
                    <ul class="space-y-5">
                        <li class="flex items-start gap-3">
                            <flux:icon.clock class="mt-0.5 size-5 shrink-0 text-emerald-400" />
                            <div>
                        ...
                        <li class="flex items-start gap-3">
                            <flux:icon.magnifying-glass class="mt-0.5 size-5 shrink-0 text-emerald-400" />
                            <div>
                        ...
                        <li class="flex items-start gap-3">
                            <flux:icon.document-check class="mt-0.5 size-5 shrink-0 text-emerald-400" />
                            <div>
